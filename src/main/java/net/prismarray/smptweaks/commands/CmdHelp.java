...
public class CmdHelp implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage("\n§e/message, /msg\n§7>> §fSend a player a private message");
        sender.sendMessage("\n§e/reply, /r\n§7>> §fReply to the last private message");
        ...
        sender.sendMessage("\n§e/invite\n§7>> §fInvite a player to the server. You will be logged as the inviter and held liable for misbehavior!");
